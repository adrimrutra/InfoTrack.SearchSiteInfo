using InfoTrack.SearchSiteInfo.UseCases.Contributors;
using InfoTrack.SearchSiteInfo.UseCases.Contributors.List;
using Microsoft.EntityFrameworkCore;

namespace InfoTrack.SearchSiteInfo.Infrastructure.Data.Queries;
